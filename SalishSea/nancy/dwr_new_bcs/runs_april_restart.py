...
def main():
    ...
    for run_id, lateral in zip(run_ids, laterals):
        init = ('/home/nksoonti/MEOPAR/SalishSea/results/'
                '{}/restart/SalishSea_02220480_restart.nc'.format(run_id))
        run_desc['forcing']['initial conditions'] = init
...
def do_run(run_id, run_desc, lateral):
    ...
    salishsea_cmd.api.run_in_subprocess(
        ...
        run_desc,
        'iodef.eddy.1d.xml',
        os.path.join('/home/nksoonti/MEOPAR/SalishSea/results/', 
                     run_id, 'restart2'))
