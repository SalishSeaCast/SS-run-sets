...
def main():
    ...
    run_ids = ['dwr_base_enst_eng',]# 'dwr_base_enst'],
    laterals = [ 'namelist.lateral',]#'namelist.lateral']
    dynamics = ['namelist.dynamics',]# 'namelist.dynamics.enst']
...
def base_run_description():
    ...
    run_desc['MPI decomposition'] = '12x27'
    return run_desc
